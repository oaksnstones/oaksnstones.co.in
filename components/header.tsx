      ...
      <div className="hidden border-b border-border bg-primary px-6 py-2 text-primary-foreground md:block">
        <div className="mx-auto flex max-w-7xl items-center justify-between text-sm">
          ...
          <div className="flex items-center gap-1 text-xs text-primary-foreground/70">
            <span className="inline-flex items-center gap-1 rounded-full bg-accent/20 px-3 py-0.5 text-accent">
              ★ 4.9 · 250+ Google Reviews
            </span>
            <span className="ml-2 rounded-full bg-primary-foreground/10 px-3 py-0.5">
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col gap-4 px-6 py-6">
              <Link href="/" onClick={() => setIsOpen(false)} className="text-lg font-medium text-foreground hover:text-accent">Home</Link>
              <Link href="/about" onClick={() => setIsOpen(false)} className="text-lg font-medium text-foreground hover:text-accent">About</Link>
              <Link href="/services" onClick={() => setIsOpen(false)} className="text-lg font-medium text-foreground hover:text-accent">Services</Link>
              <Link href="/portfolio" onClick={() => setIsOpen(false)} className="text-lg font-medium text-foreground hover:text-accent">Portfolio</Link>
              <Link href="/blog" onClick={() => setIsOpen(false)} className="text-lg font-medium text-foreground hover:text-accent">Blog</Link>
              <Link href="/faq" onClick={() => setIsOpen(false)} className="text-lg font-medium text-foreground hover:text-accent">FAQ & Budget Guide</Link>
